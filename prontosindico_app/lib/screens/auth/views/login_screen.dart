...
import 'package:prontosindico/components/error_display_widget.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    ref.listen<LoginState>(loginControllerProvider, (_, next) {
      if (next is LoginError) {
        ErrorDisplayWidget.showSnackBar(context, next.message);
        ref.read(loginControllerProvider.notifier).reset();
      } else if (next is LoginSuccess) {
        debugPrint('[LoginScreen] Login SUCCESS, navigating to EntryPoint...');

...
import 'package:prontosindico/screens/home/menu_inferior.dart';
import 'package:prontosindico/providers/auth_provider.dart';
import 'package:prontosindico/screens/auth/views/login_screen.dart';
...
class _UserDataGate extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return userAsync.when(
      ...
      data: (appUser) {
        if (appUser == null) {
          // Se não encontrar os dados imediatamente (comum no primeiro login),
          // mostramos o loading por um momento enquanto o banco sincroniza.
          debugPrint(
              '[UserDataGate] AppUser is null, waiting for data for: $uid');

...
List<CategoryModel> demoCategories = [
  CategoryModel(name: "Todas as categorias"),
  CategoryModel(
      name: "Em promoção",
      svgSrc: "assets/icons/Sale.svg",
      route: onSaleScreenRoute),
  CategoryModel(name: "Masculino", svgSrc: "assets/icons/Man.svg"),
  CategoryModel(name: "Feminino", svgSrc: "assets/icons/Woman.svg"),
  CategoryModel(
      name: "Infantil",

...
class AuthRepository implements IAuthRepository {
  ...
  AuthRepository({
    ...
    DatabaseReference? usuariosRef,
        ...
        _usuariosRef = usuariosRef ?? FirebaseDatabase.instance.ref('usuarios');
  ...
  Future<void> _persistNewUser(User firebaseUser) async {
    ...
    try {
      debugPrint(
          '[AuthRepository] Checking admin status for ${firebaseUser.email}');
      final adminsSnapshot = await _usuariosRef.parent!
          .child('config/admins')
          .get()
    ...
    await userRef.set({
      ...
      'role': role,
      'ativo':
          true, // Temporariamente true para facilitar testes e garantir redirecionamento
    });
